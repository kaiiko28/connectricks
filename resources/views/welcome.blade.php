...
<head>
    ...
    <title>{{ config('app.name', 'Connectrics') }}</title>
...
<body id="page-top">
	<div id="fullpage">
		...
		<nav class="navbar fixed-top navbar-expand-lg navbar-light" id="header-fix">
			<div class="container">
						<a class="navbar-brand" href="{{ url('/home') }}" style="color: #fff;"><img class="img-responsive" style="width:50px"  src="{{ asset('logo.png') }}" alt="Connectrics"> {{ config('app.name', 'Connectrics') }}</a>
			...
			<div class="container">
				<div class="row pt-5">
					<div class="col-lg-8 col-md-12 mx-auto align-items-center pt2">
						<h1 class="display-5 font-weight-bold  text-uppercase text-white pt-5">Connectrics</h1>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-7 col-md-7 text-white  pt2">
						<h1 class="display-5 text-uppercase font-weight-bold text-white mb-3 pt-5"> About Connectrics  </h1>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 col-md-8 mx-auto text-center">
						...
						<p>Here the steps and ways to earn here in Connectrics</p>
					</div>
				</div>
				<div class="row mt-4">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 mx-auto text-center">
						<h6 class="text-white">2019 All Right Reserved By Connectrics Online</h6>
