...
@section('content')
    ...
    <div class="row">
                                        ...
                                        {{csrf_field()}}
                                            ...
                                            <div class="col-sm-12 CursiveOption" id="incode" style="padding: 10px;">
                                                ...
                                                @php
                                                        ...
                                                        $textcolor = imagecolorallocate($img, 86, 61, 124);
                                                        $font = base_path('resources/views/dashboard/fonts/cRAZY sTYLE.ttf');
            ...
            <div class="col-sm-12"  id="status" style="margin-top:10px;">
                <div class="row">
                    <div class="col-md-6">
