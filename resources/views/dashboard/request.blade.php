...
@section('breadcrumbs')
    <h1>REQUEST <strong>ENCASHMENT</strong>
                        ...
                        <div class="">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="invoice-address">
                                    ...
                                    <div class="row">
                                            <div class="col-sm-4">
                                                    Account Name: <input type="text" class="form-control pull-right" id="fullName" name="fullName" placeholder="Name" value="{{auth()->user()->firstname}} {{auth()->user()->lastname}} " required ></span>
                                            </div>
